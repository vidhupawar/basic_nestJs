...
exports.TalonicService = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let TalonicService = class TalonicService {
    constructor(talonicModel) {
        this.talonicModel = talonicModel;
    }
    async create(createTalonicDto) {
    ...
    async update(id, updateTalonicDto) {
...
TalonicService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('Talonic')),
    __metadata("design:paramtypes", [mongoose_2.Model])
], TalonicService);
exports.TalonicService = TalonicService;
//# sourceMappingURL=talonic.service.js.map